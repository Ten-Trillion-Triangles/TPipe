...
class KimiReasoningTest {
    ...
    @Test
    fun testKimi25Reasoning() {
        println("Testing Kimi 2.5 Reasoning Extraction")
        runReasoningTest("moonshotai.kimi-k2.5", "kimi-25-trace.html")
    }

    @Test
    fun testKimiK2ThinkingReasoning() {
        println("Testing Kimi K2 Thinking Reasoning Extraction")
        runReasoningTest("moonshot.kimi-k2-thinking", "kimi-k2-thinking-trace.html")
    }
