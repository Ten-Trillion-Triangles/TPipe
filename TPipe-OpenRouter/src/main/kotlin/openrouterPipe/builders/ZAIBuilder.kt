...
/**
 * Request builder for Z-AI models via OpenRouter.
 * Handles z-ai/ prefix models.
 */
class ZAIBuilder : BaseOpenRouterModelBuilder() {
    override fun canHandle(model: String): Boolean = model.contains("z-ai/")
