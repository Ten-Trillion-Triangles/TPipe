...
/**
 * Request builder for Nous Research models via OpenRouter.
 * Handles nousresearch/ prefix models.
 */
class NousResearchBuilder : BaseOpenRouterModelBuilder() {
    override fun canHandle(model: String): Boolean = model.contains("nousresearch/")
