...
/**
 * Request builder for Google models via OpenRouter.
 * Handles google/ prefix models (Gemini, etc.).
 */
class GoogleBuilder : BaseOpenRouterModelBuilder() {
    override fun canHandle(model: String): Boolean = model.contains("google/")
