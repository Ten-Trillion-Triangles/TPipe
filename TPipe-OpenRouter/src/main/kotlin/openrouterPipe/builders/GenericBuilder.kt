...
/**
 * Generic fallback request builder for OpenRouter models.
 * Handles any model that doesn't match specific provider builders.
 */
class GenericBuilder : BaseOpenRouterModelBuilder() {
    override fun canHandle(model: String): Boolean = true  // Fallback
