...
/**
 * Request builder for Anthropic models via OpenRouter.
 * Handles anthropic/ prefix models (Claude, etc.).
 */
class AnthropicBuilder : BaseOpenRouterModelBuilder() {
    override fun canHandle(model: String): Boolean = model.contains("anthropic/")
