...
/**
 * Request builder for Liquid models via OpenRouter.
 * Handles liquid/ prefix models.
 */
class LiquidBuilder : BaseOpenRouterModelBuilder() {
    override fun canHandle(model: String): Boolean = model.contains("liquid/")
