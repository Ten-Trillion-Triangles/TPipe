...
/**
 * Request builder for Meta Llama models via OpenRouter.
 * Handles meta-llama/ prefix models.
 */
class MetaLlamaBuilder : BaseOpenRouterModelBuilder() {
    override fun canHandle(model: String): Boolean = model.contains("meta-llama/")
