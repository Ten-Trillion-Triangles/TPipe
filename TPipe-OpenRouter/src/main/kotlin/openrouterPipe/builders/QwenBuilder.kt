...
/**
 * Request builder for Qwen models via OpenRouter.
 * Handles qwen/ prefix models.
 */
class QwenBuilder : BaseOpenRouterModelBuilder() {
    override fun canHandle(model: String): Boolean = model.contains("qwen/")
