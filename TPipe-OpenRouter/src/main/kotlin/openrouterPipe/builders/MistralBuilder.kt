...
/**
 * Request builder for Mistral AI models via OpenRouter.
 * Handles mistralai/ prefix models.
 */
class MistralBuilder : BaseOpenRouterModelBuilder() {
    override fun canHandle(model: String): Boolean = model.contains("mistralai/")
