...
/**
 * Request builder for Cohere models via OpenRouter.
 * Handles cohere/ prefix models.
 */
class CohereBuilder : BaseOpenRouterModelBuilder() {
    override fun canHandle(model: String): Boolean = model.contains("cohere/")
