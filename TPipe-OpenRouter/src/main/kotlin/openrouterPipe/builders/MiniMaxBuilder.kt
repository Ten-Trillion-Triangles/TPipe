...
/**
 * Request builder for MiniMax models via OpenRouter.
 * Handles minimax/ prefix models.
 */
class MiniMaxBuilder : BaseOpenRouterModelBuilder() {
    override fun canHandle(model: String): Boolean = model.contains("minimax/")
