...
/**
 * Request builder for DeepSeek models via OpenRouter.
 * Handles deepseek/ prefix models.
 */
class DeepSeekBuilder : BaseOpenRouterModelBuilder() {
    override fun canHandle(model: String): Boolean = model.contains("deepseek/")
